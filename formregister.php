            ...
            <div class="form2">
                ...
                <form action="utility/register.php" method="post">
                    ...
                    <div class="form-content pass">
                        ...
                        <span class="show" onclick="showPassword('retype_password', 'showPassword2')"><i id="showPassword2"class="fa-solid fa-eye"></i></span>
                        <!-- <span><i class="fa-solid fa-eye-slash"></i></span> -->
                    </div>
                    <div class="submit-button">
                        <button type="register" name="register" class="submit">Register</button>
                    </div>
                    <div class="reg-google">
                        <button type="register" name="register-google" class="register"><i class="fa-brands fa-google"></i>Register With Google</button>
                    </div>
